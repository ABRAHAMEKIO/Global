...
function Create() {
  ...
  {/*[if (gte IE 9)|!(IE)]><!*/}
  {/*<![endif]*/}
  {/* Mirrored from themesflat.co/html/binaseahtml/add-NFT.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Feb 2024 21:26:56 GMT */}
  {/* Basic Page Needs */}
  <meta charSet="utf-8" />
            ...
            <div className="col-md-12">
              <div id="site-header-inner">
                ...
                <div className="header-right">
                  <a href="connect-wallet.html" className="tf-button ">
                    <span>Connect Wallet</span>
                  </a>
                  <div className="popup-user">
                    <img
                      className="avatar"
                      src="assets/images/author/admin.png"
                      alt="avatar"
                    />
                    <div className="avatar_popup">
                      ...
                      <div className="code">
                        ...
                        <a href="#" className="no-link">
                          ...
                          >
                            <g clipPath="url(#clip0_2926_10643)">
                              <path
                                d="M17.168 19.3672H7.20703C5.99533 19.3672 5.00977 18.3816 5.00977 17.1699V7.20898C5.00977 5.99728 5.99533 5.01172 7.20703 5.01172H17.168C18.3797 5.01172 19.3652 5.99728 19.3652 7.20898V17.1699C19.3652 18.3816 18.3797 19.3672 17.168 19.3672ZM7.20703 6.47656C6.80317 6.47656 6.47461 6.80512 6.47461 7.20898V17.1699C6.47461 17.5738 6.80317 17.9023 7.20703 17.9023H17.168C17.5718 17.9023 17.9004 17.5738 17.9004 17.1699V7.20898C17.9004 6.80512 17.5718 6.47656 17.168 6.47656H7.20703ZM3.54492 13.5078H2.8125C2.40864 13.5078 2.08008 13.1793 2.08008 12.7754V2.81445C2.08008 2.41059 2.40864 2.08203 2.8125 2.08203H12.7734C13.1773 2.08203 13.5059 2.41059 13.5059 2.81445V3.51025H14.9707V2.81445C14.9707 1.60275 13.9851 0.617188 12.7734 0.617188H2.8125C1.6008 0.617188 0.615234 1.60275 0.615234 2.81445V12.7754C0.615234 13.9871 1.6008 14.9727 2.8125 14.9727H3.54492V13.5078Z"
                                fill="white"
                              />
                            </g>
                            <defs>
                      ...
                      <ul className="links">
                        ...
                        <li>
                          <a className="mt-10" href="wallet-board.html">
                            <svg
                              width={20}
                              height={18}
                              viewBox="0 0 20 18"
                        ...
                        <li>
                          <a className="mt-10" href="#" id="logout">
                            <svg
                              width={20}
                              height={20}
                              viewBox="0 0 20 20"
