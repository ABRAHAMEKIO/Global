...
function Profile() {
        ...
        <div className="container-fluid">
          <div className="row">
            <div className="thumb-pagetitle">
              <img
                src="assets/images/background/thumb-pagetitle.jpg"
                alt="images"
              />
            </div>
          </div>
              ...
              <div className="dashboard-user">
                <div className="dashboard-infor">
                  <div className="avatar">
                    <img
                      src="assets/images/author/author-db.jpg"
                      alt="images"
                    />
                  </div>
                  ...
                  <div className="table-ranking ">
                    <div className="content-ranking">
                      ...
                      <div className="col-rankingg nofication">
                        {" "}
                        <i className="fas fa-circle" /> Running
                      </div>
                ...
                <div className="inner-content wallet">
                  ...
                  <div className="wallet-list">
                    <div className="tf-wallet">
                      <div className="icon">
                        <img
                          src="assets/images/svg/icon-wallet-1.svg"
                          alt="Image"
                        />
                    ...
                    <div className="tf-wallet">
                      <div className="icon">
                        <img
                          src="assets/images/svg/icon-wallet-2.svg"
                          alt="Image"
                        />
                      </div>
                      <h6 className="title">
                    ...
                    <div className="tf-wallet">
                      <div className="icon">
                        <img
                          src="assets/images/svg/icon-wallet-3.svg"
                          alt="Image"
                        />
                        <span className="label">BETA</span>
                      </div>
                    ...
                    <div className="tf-wallet">
                      <div className="icon">
                        <img
                          src="assets/images/svg/icon-wallet-4.svg"
                          alt="Image"
                        />
                      </div>
                      <h6 className="title">
                    ...
                    <div className="tf-wallet">
                      <div className="icon">
                        <img
                          src="assets/images/svg/icon-wallet-5.svg"
                          alt="Image"
                        />
                        <span className="label">BETA</span>
                      </div>
                    ...
                    <div className="tf-wallet">
                      <div className="icon">
                        <img
                          src="assets/images/svg/icon-wallet-6.svg"
                          alt="Image"
                        />
                        <span className="label">BETA</span>
                      </div>
                    ...
                    <div className="tf-wallet">
                      <div className="icon">
                        <img
                          src="assets/images/svg/icon-wallet-7.svg"
                          alt="Image"
                        />
                      </div>
                      <h6 className="title">
                    ...
                    <div className="tf-wallet">
                      <div className="icon">
                        <img
                          src="assets/images/svg/icon-wallet-8.svg"
                          alt="Image"
                        />
                        <span className="label">BETA</span>
                      </div>
                      ...
                      <div className="inner tf-filter-container">
                        <div className="history-details tf-loadmore 3d">
                          <div className="authorr">
                            <div className="avatar">
                              <img
                                src="assets/images/author/history-at1.jpg"
                                alt="images"
                              />
                            </div>
                            <div className="content">
                              ...
                              <div className="description">
                                started following <a href="#">Grey Peep</a>{" "}
                              </div>
                              <div className="date">
                        ...
                        <div className="history-details tf-loadmore 3d anime">
                          <div className="authorr">
                            <div className="avatar">
                              <img
                                src="assets/images/author/history-at2.jpg"
                                alt="images"
                              />
                            </div>
                            <div className="content">
                              ...
                              <div className="description">
                                purchased by <a href="#">Monica Johnson</a> for
                                4.00 ETH
                              </div>
                              <div className="date">
                                <span className="time">16:24</span>
                        ...
                        <div className="history-details tf-loadmore 3d pixel">
                          <div className="authorr">
                            <div className="avatar">
                              <img
                                src="assets/images/author/history-at3.jpg"
                                alt="images"
                              />
                            </div>
                            <div className="content">
                              ...
                              <div className="description">
                                bidded by <a href="#">Monica Johnson</a> for
                                4.00 ETH{" "}
                              </div>
                              <div className="date">
                                <span className="time">16:24</span>
                        ...
                        <div className="history-details tf-loadmore 3d cyber">
                          <div className="authorr">
                            <div className="avatar">
                              <img
                                src="assets/images/author/history-at4.jpg"
                                alt="images"
                              />
                            </div>
                            <div className="content">
                              ...
                              <div className="description">
                                <a href="#">Monica Johnson</a> offered for 4.00
                                ETH{" "}
                              </div>
                              <div className="date">
                                <span className="time">16:24</span>
                        ...
                        <div className="history-details tf-loadmore 3d cyber music">
                          <div className="authorr">
                            <div className="avatar">
                              <img
                                src="assets/images/author/history-at5.jpg"
                                alt="images"
                              />
                            </div>
                            <div className="content">
                              ...
                              <div className="description">
                                liked by <a href="#">Monica Johnson</a> for 4.00
                                ETH{" "}
                              </div>
                              <div className="date">
                                <span className="time">16:24</span>
                        ...
                        <div className="history-details tf-loadmore 3d cyber pixel">
                          <div className="authorr">
                            <div className="avatar">
                              <img
                                src="assets/images/author/history-at6.jpg"
                                alt="images"
                              />
                            </div>
                            <div className="content">
                ...
                <div className="inner-content follow">
                  ...
                  <div className="content-follow">
                    <div className="card-author">
                      <div className="avatar">
                        <img
                          src="assets/images/author/author-follow1.jpg"
                          alt="images"
                        />
                      </div>
                      <div className="name">
                    ...
                    <div className="card-author">
                      <div className="avatar">
                        <img
                          src="assets/images/author/author-follow2.jpg"
                          alt="images"
                        />
                      </div>
                      <div className="name">
                        {" "}
                        <a href="#">Leopold Hum</a>{" "}
                      </div>
                      <div className="details">
                        <span>64</span> Items
                      </div>
                    ...
                    <div className="card-author">
                      <div className="avatar">
                        <img
                          src="assets/images/author/author-follow3.jpg"
                          alt="images"
                        />
                      </div>
                      <div className="name">
                        {" "}
                        <a href="#">Rosemary Welch</a>{" "}
                      </div>
                      <div className="details">
                        <span>64</span> Items
                      </div>
                    ...
                    <div className="card-author">
                      <div className="avatar">
                        <img
                          src="assets/images/author/author-follow4.jpg"
                          alt="images"
                        />
                      </div>
                      <div className="name">
                    ...
                    <div className="content-ranking">
                      ...
                      <div className="col-rankingg">
                        <div className="author-pd">
                          <div className="avatar">
                            <img
                              src="assets/images/author/avt-fv1.jpg"
                              alt="images"
                            />
                          </div>
                          <a href="#" className="name">
                    ...
                    <div className="content-ranking">
                      ...
                      <div className="col-rankingg">
                        <div className="author-pd">
                          <div className="avatar">
                            <img
                              src="assets/images/author/avt-fv3.jpg"
                              alt="images"
                            />
                          </div>
                          <a href="#" className="name">
                    ...
                    <div className="content-ranking">
                      ...
                      <div className="col-rankingg">
                        <div className="author-pd">
                          <div className="avatar">
                            <img
                              src="assets/images/author/avt-fv4.jpg"
                              alt="images"
                            />
                          </div>
                          <a href="#" className="name">
                    ...
                    <div className="content-ranking">
                      ...
                      <div className="col-rankingg">
                        <div className="author-pd">
                          <div className="avatar">
                            <img
                              src="assets/images/author/avt-fv5.jpg"
                              alt="images"
                            />
                          </div>
                          <a href="#" className="name">
                    ...
                    <div className="content-ranking">
                      ...
                      <div className="col-rankingg">
                        <div className="author-pd">
                          <div className="avatar">
                            <img
                              src="assets/images/author/avt-fv6.jpg"
                              alt="images"
                            />
                          </div>
                          <a href="#" className="name">
                    ...
                    <div className="content-ranking">
                      ...
                      <div className="col-rankingg">
                        <div className="author-pd">
                          <div className="avatar">
                            <img
                              src="assets/images/author/avt-fv7.jpg"
                              alt="images"
                            />
                          </div>
                          <a href="#" className="name">
  ...
  <a id="scroll-top" />
  {/* Javascript */}
  {/* Mirrored from themesflat.co/html/binaseahtml/inventory.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Feb 2024 21:26:49 GMT */}
</>
